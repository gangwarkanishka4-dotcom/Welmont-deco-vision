const CONFIG = {
  SUPERVISED: {
    label: 'Supervised',
    className: 'bg-status-supervised/15 text-status-supervised border-status-supervised/30',
  },
  WAITING_FOR_ADULT: {
    label: 'Waiting for Adult',
...
export function SupervisionStatusBadge({ status }) {
