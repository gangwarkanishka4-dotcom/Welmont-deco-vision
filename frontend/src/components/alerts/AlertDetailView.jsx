...
export function AlertDetailView({ alertId }) {
  ...
  // No setLoading(true) here: the parent remounts this component (key={alertId}) whenever the
  // incident changes, so `loading` already starts true from its useState initializer.
  useEffect(() => {
