...
import { formatSecondsDuration } from '../utils/format.js';
...
const SEVERITY_COLORS = { LOW: '#64748b', MEDIUM: '#f59e0b', HIGH: '#ef4444' };

function averageResolutionSeconds(alerts) {
...
export function AnalyticsPage() {
  ...
  const severityData = useMemo(() => {
    ...
    return Object.keys(counts).map((severity) => ({ severity, count: counts[severity] }));
  }, [alerts]);
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <Tile
          ...
          value={avgResolution !== null ? formatSecondsDuration(avgResolution) : '—'}
        />
      </div>
